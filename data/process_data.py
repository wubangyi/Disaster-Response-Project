...
def clean_data(df):
    #1. Split categories into separate category columns by ';'
    categories = df['categories'].str.split(';', expand= True)
    #2  make up new column name based on the first row of df 
...
def save_data(df, database_filename):
    ...
    df.to_sql('DisasterInfomation', engine, index = False)
